/*******************************************************************************
* File Name: Analog_Digital_Converter_Dummy_theACLK.c
* Version 2.10
*
*  Description:
...
/*******************************************************************************
* Function Name: Analog_Digital_Converter_Dummy_theACLK_Start
********************************************************************************
*
* Summary:
...
*
*******************************************************************************/
void Analog_Digital_Converter_Dummy_theACLK_Start(void) 
{
    /* Set the bit to enable the clock. */
    Analog_Digital_Converter_Dummy_theACLK_CLKEN |= Analog_Digital_Converter_Dummy_theACLK_CLKEN_MASK;
	Analog_Digital_Converter_Dummy_theACLK_CLKSTBY |= Analog_Digital_Converter_Dummy_theACLK_CLKSTBY_MASK;
}


/*******************************************************************************
* Function Name: Analog_Digital_Converter_Dummy_theACLK_Stop
********************************************************************************
*
* Summary:
...
*
*******************************************************************************/
void Analog_Digital_Converter_Dummy_theACLK_Stop(void) 
{
    /* Clear the bit to disable the clock. */
    Analog_Digital_Converter_Dummy_theACLK_CLKEN &= (uint8)(~Analog_Digital_Converter_Dummy_theACLK_CLKEN_MASK);
	Analog_Digital_Converter_Dummy_theACLK_CLKSTBY &= (uint8)(~Analog_Digital_Converter_Dummy_theACLK_CLKSTBY_MASK);
}
...
/*******************************************************************************
* Function Name: Analog_Digital_Converter_Dummy_theACLK_StopBlock
********************************************************************************
*
* Summary:
...
*
*******************************************************************************/
void Analog_Digital_Converter_Dummy_theACLK_StopBlock(void) 
{
    if ((Analog_Digital_Converter_Dummy_theACLK_CLKEN & Analog_Digital_Converter_Dummy_theACLK_CLKEN_MASK) != 0u)
    {
...
#if defined(Analog_Digital_Converter_Dummy_theACLK__CFG3)
        CLK_DIST_AMASK = Analog_Digital_Converter_Dummy_theACLK_CLKEN_MASK;
        CLK_DIST_DMASK = 0x00u;
#else
        CLK_DIST_DMASK = Analog_Digital_Converter_Dummy_theACLK_CLKEN_MASK;
        CLK_DIST_AMASK = 0x00u;
#endif /* Analog_Digital_Converter_Dummy_theACLK__CFG3 */

        /* Clear mask of bus clock. */
        CLK_DIST_BCFG2 &= (uint8)(~BCFG2_MASK);

        oldDivider = CY_GET_REG16(Analog_Digital_Converter_Dummy_theACLK_DIV_PTR);
        ...
        CLK_DIST_LD = 0x00u;
        CY_SET_REG16(Analog_Digital_Converter_Dummy_theACLK_DIV_PTR, oldDivider);
#endif /* HAS_CLKDIST_LD_DISABLE */
    }
}
...
/*******************************************************************************
* Function Name: Analog_Digital_Converter_Dummy_theACLK_StandbyPower
********************************************************************************
*
* Summary:
...
*
*******************************************************************************/
void Analog_Digital_Converter_Dummy_theACLK_StandbyPower(uint8 state) 
{
    if(state == 0u)
    {
        Analog_Digital_Converter_Dummy_theACLK_CLKSTBY &= (uint8)(~Analog_Digital_Converter_Dummy_theACLK_CLKSTBY_MASK);
...
/*******************************************************************************
* Function Name: Analog_Digital_Converter_Dummy_theACLK_SetDividerRegister
********************************************************************************
*
* Summary:
...
*
*******************************************************************************/
void Analog_Digital_Converter_Dummy_theACLK_SetDividerRegister(uint16 clkDivider, uint8 restart)
                                
{
    uint8 enabled;

    uint8 currSrc = Analog_Digital_Converter_Dummy_theACLK_GetSourceRegister();
    uint16 oldDivider = Analog_Digital_Converter_Dummy_theACLK_GetDividerRegister();

    if (clkDivider != oldDivider)
    {
        enabled = Analog_Digital_Converter_Dummy_theACLK_CLKEN & Analog_Digital_Converter_Dummy_theACLK_CLKEN_MASK;
        ...
        if ((currSrc == (uint8)CYCLK_SRC_SEL_CLK_SYNC_D) && ((oldDivider == 0u) || (clkDivider == 0u)))
        {
            ...
            if (oldDivider == 0u)
            {
                ...
                CY_SET_REG16(Analog_Digital_Converter_Dummy_theACLK_DIV_PTR, clkDivider);
                Analog_Digital_Converter_Dummy_theACLK_MOD_SRC &= (uint8)(~CYCLK_SSS);
            }
            else
            {
                /* Moving to SSS, set SSS which then ignores the divider and we can set     */
                /* it without bothering with the shadow load.                               */
                Analog_Digital_Converter_Dummy_theACLK_MOD_SRC |= CYCLK_SSS;
                CY_SET_REG16(Analog_Digital_Converter_Dummy_theACLK_DIV_PTR, clkDivider);
            }
        }
        else
        {
            ...
            if (enabled != 0u)
            {
                ...
                if (((Analog_Digital_Converter_Dummy_theACLK_MOD_SRC & CYCLK_SYNC) == 0u) || (clkDivider == 0u))
                {
#if HAS_CLKDIST_LD_DISABLE
                    CY_SET_REG16(CYREG_CLKDIST_WRK0, oldDivider);
                    CLK_DIST_LD = CYCLK_LD_DISABLE|CYCLK_LD_SYNC_EN|CYCLK_LD_LOAD;
            ...
            else
            {
                ...
                CY_SET_REG16(Analog_Digital_Converter_Dummy_theACLK_DIV_PTR, clkDivider);
				Analog_Digital_Converter_Dummy_theACLK_CLKEN |= enabled;
            }
        }
    }
}
...
/*******************************************************************************
* Function Name: Analog_Digital_Converter_Dummy_theACLK_GetDividerRegister
********************************************************************************
*
* Summary:
...
*
*******************************************************************************/
uint16 Analog_Digital_Converter_Dummy_theACLK_GetDividerRegister(void) 
{
    return CY_GET_REG16(Analog_Digital_Converter_Dummy_theACLK_DIV_PTR);
}


/*******************************************************************************
* Function Name: Analog_Digital_Converter_Dummy_theACLK_SetModeRegister
********************************************************************************
*
* Summary:
...
*
*******************************************************************************/
void Analog_Digital_Converter_Dummy_theACLK_SetModeRegister(uint8 modeBitMask) 
{
    Analog_Digital_Converter_Dummy_theACLK_MOD_SRC |= modeBitMask & (uint8)Analog_Digital_Converter_Dummy_theACLK_MODE_MASK;
}


/*******************************************************************************
* Function Name: Analog_Digital_Converter_Dummy_theACLK_ClearModeRegister
********************************************************************************
*
* Summary:
...
*
*******************************************************************************/
void Analog_Digital_Converter_Dummy_theACLK_ClearModeRegister(uint8 modeBitMask) 
{
    Analog_Digital_Converter_Dummy_theACLK_MOD_SRC &= (uint8)(~modeBitMask) | (uint8)(~(uint8)(Analog_Digital_Converter_Dummy_theACLK_MODE_MASK));
}


/*******************************************************************************
* Function Name: Analog_Digital_Converter_Dummy_theACLK_GetModeRegister
********************************************************************************
*
* Summary:
...
*
*******************************************************************************/
uint8 Analog_Digital_Converter_Dummy_theACLK_GetModeRegister(void) 
{
    return Analog_Digital_Converter_Dummy_theACLK_MOD_SRC & (uint8)(Analog_Digital_Converter_Dummy_theACLK_MODE_MASK);
}


/*******************************************************************************
* Function Name: Analog_Digital_Converter_Dummy_theACLK_SetSourceRegister
********************************************************************************
*
* Summary:
...
*
*******************************************************************************/
void Analog_Digital_Converter_Dummy_theACLK_SetSourceRegister(uint8 clkSource) 
{
    uint16 currDiv = Analog_Digital_Converter_Dummy_theACLK_GetDividerRegister();
    uint8 oldSrc = Analog_Digital_Converter_Dummy_theACLK_GetSourceRegister();
        ...
        (clkSource == ((uint8)CYCLK_SRC_SEL_CLK_SYNC_D))) && (currDiv == 0u))
    {
        ...
        Analog_Digital_Converter_Dummy_theACLK_MOD_SRC |= CYCLK_SSS;
        Analog_Digital_Converter_Dummy_theACLK_MOD_SRC =
            (Analog_Digital_Converter_Dummy_theACLK_MOD_SRC & (uint8)(~Analog_Digital_Converter_Dummy_theACLK_SRC_SEL_MSK)) | clkSource;
    }
...
/*******************************************************************************
* Function Name: Analog_Digital_Converter_Dummy_theACLK_GetSourceRegister
********************************************************************************
*
* Summary:
...
*
*******************************************************************************/
uint8 Analog_Digital_Converter_Dummy_theACLK_GetSourceRegister(void) 
{
    return Analog_Digital_Converter_Dummy_theACLK_MOD_SRC & Analog_Digital_Converter_Dummy_theACLK_SRC_SEL_MSK;
}
...
/*******************************************************************************
* Function Name: Analog_Digital_Converter_Dummy_theACLK_SetPhaseRegister
********************************************************************************
*
* Summary:
...
*
*******************************************************************************/
void Analog_Digital_Converter_Dummy_theACLK_SetPhaseRegister(uint8 clkPhase) 
{
    Analog_Digital_Converter_Dummy_theACLK_PHASE = clkPhase & Analog_Digital_Converter_Dummy_theACLK_PHASE_MASK;
}


/*******************************************************************************
* Function Name: Analog_Digital_Converter_Dummy_theACLK_GetPhase
********************************************************************************
*
* Summary:
...
*
*******************************************************************************/
uint8 Analog_Digital_Converter_Dummy_theACLK_GetPhaseRegister(void) 
{
    return Analog_Digital_Converter_Dummy_theACLK_PHASE & Analog_Digital_Converter_Dummy_theACLK_PHASE_MASK;
}
