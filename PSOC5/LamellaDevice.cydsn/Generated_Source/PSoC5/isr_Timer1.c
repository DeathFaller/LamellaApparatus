...
void isr_Timer1_SetVector(cyisraddress address)
{
    ...
    ramVectorTable[CYINT_IRQ_BASE + (uint32)isr_Timer1__INTC_NUMBER] = address;
}
...
cyisraddress isr_Timer1_GetVector(void)
{
    ...
    return ramVectorTable[CYINT_IRQ_BASE + (uint32)isr_Timer1__INTC_NUMBER];
}
...
*
*   Note calling isr_Timer1_Start or isr_Timer1_StartEx will 
*   override any effect this API would have had. This API should only be called
*   after isr_Timer1_Start or isr_Timer1_StartEx has been called. 
...
{
    *isr_Timer1_INTC_PRIOR = priority << 5;
}
...
uint8 isr_Timer1_GetPriority(void)
{
    ...
    priority = *isr_Timer1_INTC_PRIOR >> 5;
